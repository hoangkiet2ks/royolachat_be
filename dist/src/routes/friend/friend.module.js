...
exports.FriendModule = FriendModule = __decorate([
    (0, common_1.Module)({
        imports: [shared_module_1.SharedModule, (0, common_1.forwardRef)(() => chat_module_1.ChatModule)],
        controllers: [friend_controller_1.FriendController],
        providers: [friend_service_1.FriendService, friend_repo_1.FriendRepository],
        exports: [friend_service_1.FriendService, friend_repo_1.FriendRepository],
    })
], FriendModule);
